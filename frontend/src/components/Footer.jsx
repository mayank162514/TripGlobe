    ...
    <div className=" bg-darkBackground text-white">
      <div className="flex flex-col  md:flex-row justify-between p-8 md:mx-32 px-5">
        <div className="w-full md:w-1/4 ">
          <h1 className="font-semibold text-xl pb-4 ">TripGlobe</h1>
          <p className="font-medium	">
            With TripGlobe you can experience new travel and the best tourist
      ...
      <div>
        <p className="text-center py-4">
          ...
          <span className="text-brightColor"> Mayank Patel </span> | All right
          reserved
        </p>
      </div>
    </div>
